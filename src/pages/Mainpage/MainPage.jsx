  ...
  <>
    ...
    <section aria-labelledby="notification-title" aria-modal="true" className="notification-sheet fixed inset-x-0 bottom-[82px] z-[60] mx-auto h-[calc(71dvh-82px)] min-h-[500px] max-w-[600px] overflow-y-auto rounded-t-[42px] bg-[#fffefb] px-6 pb-8 pt-7 shadow-[0_-4px_18px_rgba(0,0,0,0.05)]" role="dialog">
      <div className="relative flex items-center justify-center border-b border-[#cfcfcf] pb-6">
        ...
        <h2 className="text-[25px] font-extrabold tracking-[-0.04em] text-[#111]" id="notification-title">알림</h2>
      </div>
      <ul>
      ...
      <section className="mx-auto flex w-full max-w-[430px] flex-col self-start pb-5 pt-7">
        ...
        <article className="relative mt-6 min-h-[154px] overflow-hidden rounded-[24px] border-2 border-[#eee4cc] bg-white px-5 py-4 shadow-[0_3px_8px_rgba(95,75,28,0.04)]">
          <div className="relative z-10">
            ...
            <strong className="mt-1 block text-[38px] leading-none text-[#292929]">{routineAchievementRate}%</strong>
            <p className="mt-1 text-[13px] text-[#929292]">{completedRoutineCount} / {totalRoutineCount} 완료</p>
          </div>
        ...
        <h2 className="mt-6 text-[25px] font-bold tracking-[-0.04em] text-[#292929]">오늘의 루틴</h2>

        <article className={`mt-5 rounded-[24px] border-2 border-[#f2d984] bg-[#fffdf2] px-5 shadow-[0_5px_10px_rgba(170,136,36,0.08)] ${isRoutineCompleted ? 'py-6' : 'pb-7 pt-9'}`}>
          <div className="flex items-center gap-3">
            <div className="relative flex size-11 shrink-0 items-center justify-center rounded-full bg-[#fff1b9] text-[#8877ef]">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[17px] font-semibold tracking-[-0.03em] text-[#777268]">지금 수행할 시간이에요!</p>
          ...
          {!isRoutineCompleted && (
            <div className="mt-7 grid grid-cols-2 gap-3">
              <button className="flex min-h-[58px] items-center justify-center gap-2 rounded-full bg-[#f4d15d] px-3 text-[17px] font-bold text-[#37322a] shadow-[0_4px_8px_rgba(178,145,49,0.18)] active:scale-[0.98]" onClick={() => setIsRoutineCompleted(true)} type="button">
                <FiCheck className="size-5" strokeWidth={2.5} /> 완료했어요
              </button>
              <button className="min-h-[58px] rounded-full border border-[#e6e6e6] bg-white px-3 text-[16px] font-bold text-[#444] shadow-[0_3px_8px_rgba(44,44,44,0.09)] active:scale-[0.98]" type="button">못 지킬 것 같아요</button>
            </div>
