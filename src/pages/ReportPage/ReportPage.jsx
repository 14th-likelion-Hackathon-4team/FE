...
const suggestions = [
  {
    id: 1,
    message: '화·목 저녁에는 시간이 부족했어요.\n운동 루틴을 10분 대체 미션으로 바꿔볼까요?',
  },
  {
    id: 2,
    message: '주말에는 시작 시간이 자주 늦어졌어요.\n오전 루틴을 점심 전 가벼운 미션으로 바꿔볼까요?',
  },
  {
    id: 3,
    message: '피로한 날에는 긴 루틴을 미루는 경향이 있어요.\n5분짜리 최소 루틴을 준비해둘까요?',
  },
];
...
const ReportPage = () => {
  ...
  const handleNextSuggestion = () => {
    setSuggestionIndex((currentIndex) => (currentIndex + 1) % suggestions.length);
  };
